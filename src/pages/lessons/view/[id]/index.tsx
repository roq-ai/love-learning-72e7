...
import { getLessonById } from 'apiSdk/lessons';
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('lesson', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/lessons/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                {hasAccess('content', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="Content"
                    text={
                      <Link as={NextLink} href={`/contents/view/${data?.content?.id}`}>
                        {data?.content?.title}
                      </Link>
                    }
                  />
