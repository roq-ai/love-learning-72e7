...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`love learning`}</title>

        <meta
          name="description"
          content="Dive into the captivating world of Love Learning, where learning computer languages such as Python becomes an enchanting journey of storytelling."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1526379095098-d400fd0bf935?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxweXRob24lMjBsYW5ndWFnZXxlbnwwfHx8fDE2OTY0OTY5NjN8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@hiteshchoudhary?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Hitesh Choudhary`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Dive into the captivating world of Love Learning, where learning computer languages such as Python becomes an enchanting journey of storytelling.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Student" type="student" abilities={appConfig.ownerAbilities} />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
