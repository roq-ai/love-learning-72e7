...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'content.create.create': {
    roles: ['administrator', 'student', 'guest-user', 'story-teller'],
    key: 'content',
    tenantPath: [],
    userPath: [],
  },
  'story.publish.create': {
    roles: ['administrator', 'content-creator', 'student', 'guest-user'],
    key: 'story',
    tenantPath: [],
    userPath: [],
  },
  'user.promote.update': {
    roles: ['content-creator', 'student', 'guest-user', 'story-teller'],
    key: 'user',
    tenantPath: [],
    userPath: [],
  },
...
const ownerRoles: string[] = ['student'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['administrator', 'content-creator', 'student', 'guest-user', 'story-teller'];
