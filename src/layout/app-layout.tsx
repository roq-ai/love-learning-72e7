...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['student', 'administrator', 'content-creator', 'guest-user', 'story-teller'];
  ...
  const { data, error, isLoading } = useSWR<StartupInterface[]>(
    ...
    () => getStartups({ tenant_id: session?.user?.tenantId }).then(({ data }) => data),
  );
  loading = isLoading;
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Lessons', path: '/lessons', entity: 'lesson', service: AccessServiceEnum.PROJECT, icon: FiBook },
    { name: 'Stories', path: '/stories', entity: 'story', service: AccessServiceEnum.PROJECT, icon: FiBookOpen },
    { name: 'Students', path: '/students', entity: 'student', service: AccessServiceEnum.PROJECT, icon: FiUserCheck },
